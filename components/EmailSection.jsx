        ...
        <main className="grid md:grid-cols-2 my-12 md:my-12 py-24 md:py-24 gap-4 relative" id="contact">
            <div className="z-10">
                ...
                <div className=" flex flex-row gap-4 mt-6">
                    <Link href="https://github.com/Brutt09">
                        <Image src={GithubIcon} alt="Github Icon" />
                    </Link>
                    <Link href="https://www.linkedin.com/feed/">
                        <Image src={LinkedinIcon} alt="Linkedin Icon" />
                    </Link>
                    <Link href="https://instagram.com/lye.brit?igshid=YTQwZjQ0NmI0OA==" className="mt-1">
                        <Image src={InstagramIcon}/>
                    </Link>
                    <Link href="mailto:leonleebrit@gmail.com" className="mt-1">
                        <Image src={GmailIcon}/>
                    </Link>
